...
echo:            ___________________________________________________
echo:         
call :_color2 %_White% "             " %_Green% "在键盘 [1,2,3,4,5] 中输入一个菜单选项"
choice /C:12345 /N
set _erl=%errorlevel%

if %_erl%==5 exit /b
if %_erl%==4 start https://massgrave.dev/idm-activation-script & goto MainMenu
...
call :_color %Green% "IDM 激活 - 在注册表中成功重置"
) else (
call :_color %Red% "无法完全重置 IDM 激活 - 试用"
)
...
echo 你可以从 https://www.internetdownloadmanager.com/download.html 下载
goto done
)
